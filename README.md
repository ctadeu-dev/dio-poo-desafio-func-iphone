...
|--------------------|------------|---------------------------------------|--------------------|---------------------------------------------------------------------------------------------------------------|
| PhoneMain          | Start      | +main(String[] args)                  | Método             | Start do aparelho (ao executar o app seria como se estivessemos apertando o botão de ligar).                  |
| -                  | -          | -                                     | -                  | -                                                                                                             |
| PhoneMainFunc      | Controle   | +solicitarAcaoUsuario()               | Método             | Disponibiliza opções para usuário tomar ação do que quer fazer.                                               |
| -                  | -          | -                                     | -                  | -                                                                                                             |
| IntfcPhoneControle | Interface  | +boolean ligarAparelho()              | Assinatura         | Simulação do procedimento de ligar o aparelho                                                                 |
| IntfcPhoneControle | Interface  | +desligarAparelho()                   | Assinatura         | Simulação do procedimento de desligar o aparelho                                                              |
| IntfcPhoneControle | Interface  | +aumentarVolume()                     | Assinatura         | Simulação do procedimento de aumentar o volume do aparelho                                                    |
| IntfcPhoneControle | Interface  | +diminuirVolume()                     | Assinatura         | Simulação do procedimento de diminuir o volume do aparelho                                                    |
| IntfcPhoneControle | Interface  | +autenticarUsuario()                  | Assinatura         | Simulação do procedimento de autenticação do Usuario                                                          |
| -                  | -          | -                                     | -                  | -                                                                                                             |
...
| PhoneControle      | Controle   | -mudarPosicaoAparelho()               | Método             | Mudar a posição da tela quando o aparelho mudar de posição (Vertical ou Horizontal).                          |
...
| Seguranca          | Acesso     | -validarUsuarioSenha()                | Método             | Validar credencial por usuário e senha.                                                                       |
...
| Contato            | Informação | -tipoTelefone                         | Atributo (String)  | Tipo do contato (Residencial, Comercial, Whatsapp, Outros).                                                   |
| Contato            | Informação | -descTipoOutro                        | Atributo (String)  | Quando informado outros, este campo recebe a descrição.                                                       |
| -                  | -          | -                                     | -                  | -                                                                                                             |
...
| -                  | -          | -                                     | -                  | -                                                                                                             |
| Telefone           | Ligação    | -verificarSinalRede()                 | Método             | Verifica o estado da rede de telefonia ao realizar chamada.                                                   |
| Telefone           | Ligação    | +atenderChamada()                     | Método             | Executa uma ação de atendimento de chamada telafônica.                                                        |
| Telefone           | Ligação    | +fazerChamada(numeroTelefDestino)     | Método             | Executa uma ação de realizar chamada.                                                                         |
| Telefone           | Ligação    | +desligarChamada()                    | Método             | Finaliza a chamada telefônica ativa.                                                                          |
| -                  | -          | -                                     | -                  | -                                                                                                             |
